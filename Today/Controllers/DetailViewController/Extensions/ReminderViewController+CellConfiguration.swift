...
extension ReminderViewController {
    ...
    func headerConfiguration(for cell: UICollectionViewListCell, with label: String) -> UIListContentConfiguration {
        var contentConfiguration = cell.defaultContentConfiguration()
    ...
    private func text(for row: Row) -> String? {
        ...
        case .viewTimes: return reminder.dueDate.formatted(date: .omitted, time: .shortened)
